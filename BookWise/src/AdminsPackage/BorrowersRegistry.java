 ...
 * @author SCC
 */
public class BorrowersRegistry extends javax.swing.JFrame {

    /**
     * Creates new form BorrowersRegistry
     */
    ...
    try {
        ...
        ResultSet rs = conf.getData("SELECT u_firstname, u_lastname, u_cnumber, u_email, u_type, u_status FROM user WHERE u_type = 'Borrower'");           
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Borrowers Registry");
        ...
        jLabel4.setText("List of Borrowers");
        jLabel4.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true));
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 120, 220, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BorrowersRegistry.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BorrowersRegistry().setVisible(true);
            }
        });
    }
